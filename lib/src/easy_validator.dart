...
class EasyValidator<T> extends StatefulWidget {
  ...
  @override
  EasyValidatorState<T> createState() => EasyValidatorState<T>();
}

class EasyValidatorState<T> extends State<EasyValidator<T>> {
